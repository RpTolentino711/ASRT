                      ...
                      <?php for ($i=1; $i<=5; $i++): $field = "Photo$i"; ?>
                        <div style="margin-bottom:8px;">
                          <?php if (!empty($space[$field])): ?>
                            ...
                            <form method="post" class="unit-photo-form" style="display:inline" enctype="multipart/form-data">
                              ...
                              <button type="submit" class="btn btn-sm btn-primary">Update <?= $field ?></button>
                            </form>
                            <form method="post" class="unit-photo-form" style="display:inline" onsubmit="return confirm('Delete this photo?');">
                          ...
                          <?php else: ?>
                            <form method="post" class="unit-photo-form" style="display:inline" enctype="multipart/form-data">
                              ...
                              <input type="hidden" name="space_id" value="<?= $space['Space_ID'] ?>">
                              <input type="hidden" name="photo_field" value="<?= $field ?>">
                              <button type="submit" class="btn btn-sm btn-primary">Upload <?= $field ?></button>
                            </form>
                          <?php endif; ?>
                        </div>
                      <?php endfor; ?>
